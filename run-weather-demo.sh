...
# AMCP v1.5 Open Source Edition Weather System Demo Launcher
...
echo -e "${BLUE}╔═══════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║           AMCP v1.5 Open Source Edition Launcher              ║${NC}"
...
if [[ ! -d "examples" ]] || [[ ! -d "core" ]]; then
    ...
    echo "  amcp-v1.5-opensource-edition/"
    echo "    ├── core/"
    echo "    ├── examples/"
...
echo -e "${BLUE}Thank you for trying AMCP v1.5 Open Source Edition Weather System Demo${NC}"