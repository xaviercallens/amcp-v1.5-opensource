...
# AMCP v1.5 Enterprise Edition - Comprehensive Demo & Test Suite
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --no-performance)
            ...
            ;;
        -h|--help)
            echo "AMCP v1.5 Enterprise Edition - Comprehensive Demo & Test Suite"
            echo ""
...
show_banner() {
    ...
    Agent Mesh Communication Protocol v1.5 Enterprise Edition
...
check_prerequisites() {
    ...
    if [[ ! -d "examples" ]] || [[ ! -d "core" ]] || [[ ! -d "connectors" ]]; then
        ...
        info "Expected structure: amcp-v1.5-enterprise-edition/ with core/, examples/, connectors/ directories"
        exit 1
    fi
...
build_project() {
    ...
    log "Building AMCP v1.5 Enterprise Edition..."
...
test_testing_framework() {
    ...
    section "🧪 ENTERPRISE TESTING FRAMEWORK"
...
main() {
    ...
    echo -e "\n${WHITE}🎉 AMCP v1.5 Enterprise Edition Demo Complete!${NC}"
